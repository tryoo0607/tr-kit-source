...
|---|---|---|---|
| Claude Code | `out/claude/` | [`tr-claude`](https://github.com/tryoo0607/tr-claude) | [`v0.5.0`](https://github.com/tryoo0607/tr-claude/releases/tag/v0.5.0) |
| Codex | `out/codex/` | [`tr-codex`](https://github.com/tryoo0607/tr-codex) | [`v0.5.0`](https://github.com/tryoo0607/tr-codex/releases/tag/v0.5.0) |
